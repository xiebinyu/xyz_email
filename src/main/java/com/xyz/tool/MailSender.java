...
public class MailSender {
    ...
    //发件人邮箱
    private static String account = "1006251853@qq.com";
    //发件人邮箱密码（授权码）
    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String password = "muqppunbxtrabcbhxyzfw";
    ...
    */
    public static void sendEmail(String toEmailAddress, String emailTitle, String emailContent) throws Exception{
      ...
      builder.append("\n" + emailContent);
      //写入我的官网
      builder.append("\n官网：" + "https://i.csdn.net/#/uc/profile");
      //定义要输出日期字符串的格式
      ...
      msg.setFrom(new InternetAddress(account,"CSDN", "UTF-8"));
      //得到邮差对象
    ...
    public static void main(String[] args) throws Exception {
      sendEmail("xiebinyu@xdf.cn", "test", "there is nothing!");
    }
}